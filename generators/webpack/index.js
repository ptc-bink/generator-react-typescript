...
module.exports = class extends base_1.BaseGenerator {
    ...
    writing() {
        this.fs.copyTpl(this.templatePath('webpack.config.js.ejs'), this.destinationPath(`webpack.production.config.js`), {
            src: this.settings.src,
            bin: this.settings.bin,
            scss: this.settings.css === base_1.CssPreprocessor.scss,
            production: true,
            development: false,
            cssModules: this.cssModules
        });
        this.fs.copyTpl(this.templatePath('webpack.config.js.ejs'), this.destinationPath(`webpack.development.config.js`), {
            src: this.settings.src,
            bin: this.settings.bin,
            scss: this.settings.css === base_1.CssPreprocessor.scss,
            production: false,
    ...
    install() {
        ...
        if (this.settings.css === base_1.CssPreprocessor.scss) {
